...
class GUI_Window:
	...
	def __init__(self, master):
		...
		def browse():
			...
			self.file_to_open = fdialog.askopenfilename(initialdir = "C:\\Users", title = "Open to translate a text file", filetypes = (("text files", "*.txt"),("all files","*.*")))
	...
	def open_file(self):
		...
		# openig dialog box to open text file
		self.file_to_open = fdialog.askopenfilename(initialdir = "C:\\Users", title = "Open to edit a text file", filetypes = (("text files", "*.txt"),("all files","*.*")))

		# loading and displaying the file and it's content to text box 1
		os.system("notepad " + self.file_to_open)
